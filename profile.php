...
<div class="form-wrap">
    <form action="edituser.php" method="post" id="register-form">
            <div class="form-group">
                ...
                <input type="text" name="firstname" id="firstname" value="<?= $retVal = (!empty($firstname)) ? $firstname : '' ;?>" class="form-control" placeholder="first name" disabled>
            ...
            <div class="form-group">
                ...
                <input type="text" name="lastname" id="lastname" value="<?= $retVal = (!empty($lastname)) ? $lastname : '' ;?>" class="form-control" placeholder="" disabled>
            ...
            <div class="form-group">
                ...
                <input type="text" name="othername" id="othername" value="<?= $retVal = (!empty($othername)) ? $othername : '' ;?>" class="form-control" placeholder="" disabled>
                <span class="error text-danger" ><?php echo $othernameErr = (!empty($othernameErr)) ? $othernameErr : ""; ?></span>
            </div>

            
            <label for="gender">Gender:<span style="color: red;">*</span></label>
            <select name="gender" id="" class="form-control" id="gender" disabled>
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" id="email" value="<?= $retVal = (!empty($email)) ? $email : '' ;?>" class="form-control" placeholder="email" disabled>
            ...
            <label for="class">User Role:<span style="color: red;">*</span></label>
                <select name="userole" id="" class="form-control" id="cause" disabled>
